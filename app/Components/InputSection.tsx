...
const InputSection = () => {
    ...
    return (
        ...
        //     <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  focus:outline-none ">Search</button>
        // </form>

<form onSubmit={handleSubmit} className='relative flex w-1/2 justify-center items-center gap-x-3'>
